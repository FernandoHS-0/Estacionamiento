...
public:
    ...
    void setupUi(QDialog *Administrador)
    {
        ...
        stackedWidget->setGeometry(QRect(130, 20, 651, 541));
        ...
        label_5->setGeometry(QRect(290, 30, 81, 16));
        Registros = new QTableWidget(page_2);
        Registros->setObjectName(QString::fromUtf8("Registros"));
        Registros->setGeometry(QRect(70, 70, 491, 311));
    ...
    void retranslateUi(QDialog *Administrador)
    {
        ...
        btnTaridas->setText(QCoreApplication::translate("Administrador", "Tarifas", nullptr));
        btnRegistros->setText(QCoreApplication::translate("Administrador", "Registros", nullptr));
        btnComentarios->setText(QCoreApplication::translate("Administrador", "Comentarios", nullptr));
        ...
        Acualizar1->setText(QCoreApplication::translate("Administrador", "PushButton", nullptr));
        TipoTarifa2->setText(QString());
        TarifaActual2->setText(QString());
        actualizar2->setText(QCoreApplication::translate("Administrador", "PushButton", nullptr));
        ...
        btnSalir->setText(QCoreApplication::translate("Administrador", "Salir", nullptr));
    } // retranslateUi
